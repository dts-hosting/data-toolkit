...
class CollectionSpaceServiceTest < ActiveSupport::TestCase
  test "format_url removes trailing slash" do
    url = "https://cs.collectionspace.org/"
    assert_equal "https://cs.collectionspace.org/cspace-services", CollectionSpaceService.format_url(url)
  end
