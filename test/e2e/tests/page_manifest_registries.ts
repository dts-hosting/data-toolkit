...
export class CheckMediaDerivativesPage {
  ...
  async navigateTo(toolkitUrl) {
    ...
    // Navigate to the Manifest Registries page
    await this.page.getByRole('link', { name: 'Manifest Registries' }).click();
    
    // Verify that we are on the correct page
    await expect(this.page.getByText('Add New Manifest Registry')).toBeVisible();
  }
