...
export class CheckMediaDerivativesPage {
  ...
  async navigateTo(toolkitUrl) {
    ...
    // Navigate to the Jobs Dashboard page
    await this.page.getByRole('link', { name: 'Jobs Dashboard' }).click();
    
    // Verify that we are on the correct page
    await expect(this.page.getByText('Back to main app')).toBeVisible();
  }
