...
export class DeleteRecordsPage {
  constructor(page) {
    this.page = page;
  }
  ...
  async navigateTo(toolkitUrl) {
    ...
    // Navigate to the Delete Records page
    await this.page.getByRole('link', { name: 'Delete Records' }).click();
    
    // Verify that we are on the correct page
    await expect(this.page.getByText('New Delete Records')).toBeVisible();
  }
