...
export class CheckMediaDerivativesPage {
  ...
  async navigateTo(toolkitUrl) {
    ...
    // Navigate to the Check Media Derivatives page
    await this.page.getByRole('link', { name: 'Check Media Derivatives' }).click();
    
    // Verify that we are on the correct page
    await expect(this.page.getByText('New Check Media Derivatives')).toBeVisible();
  }
